    ...
    <>
      ...
      >
        <g clipPath="url(#clip0_2_1362)">
          <path
            d="M11 20.5H35V35.5C35 36.052 34.552 36.5 34 36.5H12C11.448 36.5 11 36.052 11 35.5V20.5Z"
            stroke="#3C3C3C"
            strokeWidth="2"
          />
          <path d="M38 20.5H35" stroke="#3C3C3C" strokeWidth="2" />
          <path d="M11 20.5H8" stroke="#3C3C3C" strokeWidth="2" />
          <path
            d="M16.5 8.5C14.019 8.5 12 10.519 12 13C12 15.137 13.5 16.923 15.5 17.38V15.289C14.619 14.902 14 14.023 14 13C14 11.622 15.122 10.5 16.5 10.5C17.878 10.5 19 11.622 19 13C19 14.023 18.381 14.902 17.5 15.289V17.38C19.5 16.923 21 15.137 21 13C21 10.519 18.981 8.5 16.5 8.5Z"
            fill="#3C3C3C"
          />
          <path
            d="M11 20.5C11 18.291 12.791 16.5 15 16.5H14.737H15.434"
            stroke="#3C3C3C"
            strokeWidth="2"
          />
          <path
            d="M17.602 16.5H18.342C19.403 16.5 20.421 16.921 21.171 17.671L29 25.5"
            stroke="#3C3C3C"
            strokeWidth="2"
          />
          <path
